...
urlpatterns = [
    ...
    path(
        "api/users/create/", views.create_user, name="create_user"
    ),  # POST - Buat user baru
    path(
        "api/users/<int:user_id>/", views.get_user_by_id, name="get_user"
    ),  # GET - User berdasarkan ID
    path(
        "api/users/<int:user_id>/delete/", views.delete_user, name="delete_user"
    ),  # DELETE - Hapus user
    # --------------------------------------
