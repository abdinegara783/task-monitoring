    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('employee', 'Employee'), ('foreman', 'Foreman'), ('admin', 'Admin')], default='employee', max_length=20)),
                ('shift', models.CharField(blank=True, choices=[('1', 'Shift 1 (07:00 - 15:00)'), ('2', 'Shift 2 (15:00 - 23:00)')], max_length=10, null=True)),
